    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          The tax toolkit page you're looking for doesn't exist or has been moved.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  head: () => ({
    meta: [
      ...
      { title: "Complete GST & TDS Filing Kit (2026 Edition) — Simpex Media" },
      {
        name: "description",
        content:
          "Everything you need to understand GST & TDS — in one practical digital toolkit. Includes step-by-step filing guides, Excel tax calculators, calendars, invoice templates, and bonuses.",
      },
      { name: "author", content: "Simpex Media Tax & Compliance" },
